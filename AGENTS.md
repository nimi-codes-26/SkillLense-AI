...
This file lists the rules every contributor to SkillLens AI should follow. Read it, along
with the files it points to, before making a non-trivial change.
...
- [docs/DECISIONS.md](docs/DECISIONS.md) — why key choices were made, so they aren't reverted
  by accident
...
- **Do not modify the validated ML methodology casually.** The K-Means cluster count (k=4),
  ...
  [docs/ML_METHODOLOGY.md](docs/ML_METHODOLOGY.md) and [docs/DECISIONS.md](docs/DECISIONS.md).
  If you believe one should change, update the relevant docs to explain why, not just the code.
...
- **Keep documentation current.** After a change that affects behavior, update
  [docs/CURRENT_STATE.md](docs/CURRENT_STATE.md), [docs/CHANGELOG.md](docs/CHANGELOG.md), and
  [docs/DECISIONS.md](docs/DECISIONS.md) as appropriate, in the same change.
